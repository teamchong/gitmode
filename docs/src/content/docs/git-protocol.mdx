...
gitmode implements the [Git Smart HTTP protocol](https://git-scm.com/docs/http-protocol), enabling standard git clients to clone, fetch, and push. For SSH transport, see [SSH Transport](/gitmode/ssh-transport/).
