...
1. **wasm-metadce** — Dead code elimination based on an export graph. Only 27 exports are kept; all unreachable functions are removed. This reduced function count from ~3000+ to 1272.
